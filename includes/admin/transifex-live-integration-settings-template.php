		...
		<table class="form-table">
			...
			<tr class="custom-urls-settings">
				...
				<td>
					...
					<p class="submit"><input disabled="true" type="button" name="sync" id="sync" class="button button-primary" value="Refresh Languages from Transifex"></p>
